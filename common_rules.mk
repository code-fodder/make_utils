...
.PHONY: build_header
build_header:
	@echo "$(COLOUR_ACT)building $(GET_CURDIR_BASENAME) ($(TARGET) $(BUILD_TYPE)): $(COLOUR_RST) $(COLOUR_DEP)[$(DEP_MAKE_DIRS)]$(COLOUR_RST)"
...
$(OUTPUT_DIR)/$(OUTPUT_FILE): $(OBJECTS) $(LIB_DEPS)
	...
	$(CC) $(LFLAGS) $(OBJECTS) -o $(OUTPUT_DIR)/$(OUTPUT_FILE) $(LIB_LINK_FLAGS)
