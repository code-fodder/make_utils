...
$(OBJECT_DIR)/%.o: %.cpp | .build_prerequisites
	...
	$(CXX) $(FLAGS_CPP_WARNINGS) $(CXXFLAGS) $(DEFINES) $(DEP_FLAGS) $(COMPILE_PROCESSING_OPTION) $(RULE_DEPENDENCY) -o $(COMPILE_OUTPUT_LOCATION)
	-@$(POSTCOMPILE)
# Compile .cxx files
...
$(OBJECT_DIR)/%.o: %.c | .build_prerequisites
	$(CPPCHECK_BASH_CMD)
	@$(ECHO) "$(COLOUR_ACT)compiling: $(RULE_DEPENDENCY)$(COLOUR_RST)"
	$(CC) $(FLAGS_C_WARNINGS) $(CFLAGS) $(DEFINES) $(DEP_FLAGS) $(COMPILE_PROCESSING_OPTION) $(RULE_DEPENDENCY) -o $(COMPILE_OUTPUT_LOCATION)
	-@$(POSTCOMPILE)
